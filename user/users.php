...
$sql = "SELECT id, usuario, email, created, imagem FROM usuarios";
...
<head>
    ...
    <title>Garage Club | Geral Usuários</title>
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="usuarios/add.php"> <i class="fa-solid fa-plus"></i> Novo
                                    Usuário </a></li>
                            <li><a class="dropdown-item" href="usuarios"> <i class="fa-solid fa-motorcycle"></i> Ver
                                    Motos</a></li>
    ...
    <div class="container">
        <h1 class="mt-5" id="title">Lista de Usuários</h1>
        ...
        <div class="mb-3">
            <input type="text" id="searchInput" class="form-control" placeholder="Pesquisar por usuário ou email"
                onkeyup="filterTable()">
        </div>

        <div class="table-container">
            <button class="btn btn-primary mb-3" onclick="window.location.href='../user/new_user.php'">Adicionar Novo
                Usuário</button>
                                    ...
                                    <td>
                                        <?php if ($row['imagem']) { ?>
                                            <img src="data:image/jpeg;base64,<?php echo base64_encode($row['imagem']); ?>"
                                                class="img-thumbnail" alt="Imagem do Usuário">
                                        <?php } else { ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel" style="color: black; font-weight:bold">Excluir Usuário
                    </h5>
